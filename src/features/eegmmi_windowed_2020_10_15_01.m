%% TODO OVERLAPPING WINDOWS, EXPORT ALL AND LEAVE NANS if fewer modes extracted
...
%         
        export_vec=[subject,trial,reshape([real(Phi_data{opt_order}(:,1:7));imag(Phi_data{opt_order}(:,1:7));zeta_data{opt_order}(1:7).';fn_data{opt_order}(1:7).'],1,[])];
...
writecell(out,'OMA_deap_window_head.csv')